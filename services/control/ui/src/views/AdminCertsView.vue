  ...
  <div class="page">
    <div class="header">
      ...
      <div class="header-actions">
        ...
        <t-select v-model="filterDomain" placeholder="域名" clearable style="width:140px" :options="domainFilterOptions" />
    ...
    <t-dialog v-model:visible="uploadOpen" header="添加证书" width="600" :confirm-btn="{ content: '添加', loading: uploadLoading }" cancel-btn="取消" @confirm="submitUpload">
      <div class="form-stack">
        ...
        <div class="form-row"><div class="form-label">归属用户</div><t-select v-model="uploadForm.userId" :options="userOptions" placeholder="选择用户" clearable filterable /></div>
    ...
    <t-dialog v-model:visible="acmeOpen" header="申请免费证书 (Let's Encrypt)" width="500" :confirm-btn="{ content: '申请', loading: acmeLoading }" cancel-btn="取消" @confirm="submitACME">
      <div class="form-stack">
        ...
        <div class="form-row"><div class="form-label">归属用户</div><t-select v-model="acmeForm.userId" :options="userOptions" placeholder="选择用户" clearable filterable /></div>
