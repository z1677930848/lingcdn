        ...
        <div v-else class="admin-mobile-cards">
          <div v-for="item in filtered" :key="item.id" class="admin-mobile-card">
            ...
            <div class="admin-mobile-card-actions">
              <t-button size="small" theme="primary" variant="text" @click="router.push(`/dashboard/domains/${item.id}`)">管理</t-button>
      ...
      <t-tabs v-model="createTab">
        <t-tab-panel value="single" label="单个添加">
          <div class="form-stack">
            <div class="form-row">
              ...
              <t-select v-model="singleForm.orderID" :options="orderOptions" placeholder="请选择套餐" />
            </div>
        ...
        <t-tab-panel value="batch" label="批量添加">
          <div class="form-stack">
            <div class="form-row">
              <div class="form-label">套餐</div>
              <t-select v-model="batchForm.orderID" :options="orderOptions" placeholder="请选择套餐" />
            </div>
...
const loadMeta = async () => {
  try {
    ...
    MessagePlugin.error(err.message || "加载套餐列表失败")
  }
}
